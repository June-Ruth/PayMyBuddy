package com.openclassrooms.paymybuddy.login.controller;
...
public class LoginController {
    ...
    public LoginController(OAuth2AuthorizedClientService pAuthorizedClientService) {
    ...
    private StringBuffer getOAuth2LoginInfo(Principal user) {
        ...
        // NB : ne pas afficher publiquement, ici juste pour démo //TODO : supprimer ligne
